...
public class VentanaCasos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(Casos, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(131, 131, 131))
        );
    ...
    private void rellenar() {
       ArrayList <Caso> listaCasos = Ejercicio3.sacarNumerosCaso();
       for(int x=0;listaCasos.size()>x;x++){
           Integer numeroCaso=listaCasos.get(x).getNumeroExp();
           String caso=numeroCaso.toString();
           Casos.addItem(caso);
       }
       Casos.addItem("Nuevo caso");
    }
}
